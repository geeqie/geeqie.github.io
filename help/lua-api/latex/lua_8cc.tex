\doxysection{src/lua.cc File Reference}
\label{lua_8cc}\index{src/lua.cc@{src/lua.cc}}
...
Call by e.\+g. ~\newline
\doxyref{$<$exif-\/structure$>$\+:get\+\_\+datum() }{p.}{lua_8cc_ac9ce283551bf63c8147cb780bff5d209} ~\newline
where $<$exif-\/structure$>$ is the output of \doxyref{Image\+:get\+\_\+exif() }{p.}{lua_8cc_a085dc763b1a2fc6e8eeb4e0bb315268e} \end{DoxyCompactList}\item 
static const lua\+L\+\_\+\+Reg \textbf{ image\+\_\+methods} [$\,$]
\begin{DoxyCompactList}\small\item\em {\bfseries{Image\+:}} metatable and methods ~\newline
Call by e.\+g. ~\newline
path\+\_\+name = \doxyref{Image\+:getpath() }{p.}{lua_8cc_a65ddfd7d38490cdb6d21d1d09408c253} ~\newline
...
\doxyref{Image\+:}{p.}{lua_8cc_ac8629eaf0c7d181e68644c972af0c5c4} basic image information

{\bfseries{Collection}}\+: not implemented

\doxyref{$<$exif-\/structure$>$\+:get\+\_\+datum() }{p.}{lua_8cc_ae65388773267617954dbff00feb3c479} get single exif parameter 

\doxysubsection{Function Documentation}
\label{lua_8cc_ac9ce283551bf63c8147cb780bff5d209} 
\index{lua.cc@{lua.cc}!lua\_exif\_get\_datum@{lua\_exif\_get\_datum}}
\index{lua\_exif\_get\_datum@{lua\_exif\_get\_datum}!lua.cc@{lua.cc}}
...
{\itshape return} A single exif tag extracted from a structure output by the \doxyref{Image\+:get\+\_\+exif() }{p.}{lua_8cc_a085dc763b1a2fc6e8eeb4e0bb315268e} command
\end{DoxyReturn}
e.\+g. ~\newline
exif\+\_\+structure = Image\+:get\+\_\+exif(); ~\newline
Date\+Time\+Digitized = exif\+\_\+structure\+:get\+\_\+datum("{}\+Exif.\+Photo.\+Date\+Time\+Digitized"{});
...
otherwise char \label{lua_8cc_a44364b90fbb9ff09543f6fd0307f3a0a} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_date@{lua\_image\_get\_date}}
\index{lua\_image\_get\_date@{lua\_image\_get\_date}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
time\+\_\+t -\/ signed integer which represents the number of seconds since the start of the Unix epoch\+: midnight UTC of January 1, 1970 \label{lua_8cc_a085dc763b1a2fc6e8eeb4e0bb315268e} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_exif@{lua\_image\_get\_exif}}
\index{lua\_image\_get\_exif@{lua\_image\_get\_exif}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
To be used in conjunction with \doxyref{$<$exif-\/structure$>$\+:get\+\_\+datum() }{p.}{lua_8cc_ac9ce283551bf63c8147cb780bff5d209} \label{lua_8cc_a87e2f0caafe7c3b7c56d3956d9fcc7c1} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_extension@{lua\_image\_get\_extension}}
\index{lua\_image\_get\_extension@{lua\_image\_get\_extension}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
\label{lua_8cc_aa9c605d65074a310c050f036c8c8d4c8} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_marks@{lua\_image\_get\_marks}}
\index{lua\_image\_get\_marks@{lua\_image\_get\_marks}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
Bit 0 == Mark 1 etc. \label{lua_8cc_a1890e1bdf4c29bd0ab64afc24188f1dd} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_name@{lua\_image\_get\_name}}
\index{lua\_image\_get\_name@{lua\_image\_get\_name}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
\label{lua_8cc_a65ddfd7d38490cdb6d21d1d09408c253} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_path@{lua\_image\_get\_path}}
\index{lua\_image\_get\_path@{lua\_image\_get\_path}!lua.cc@{lua.cc}}
...
\end{DoxyReturn}
\label{lua_8cc_a2299bcb5935a4c8f02c0e1c20e4e2ed9} 
\index{lua.cc@{lua.cc}!lua\_image\_get\_size@{lua\_image\_get\_size}}
\index{lua\_image\_get\_size@{lua\_image\_get\_size}!lua.cc@{lua.cc}}
...
\label{lua_8cc_ae65388773267617954dbff00feb3c479} 
\index{lua.cc@{lua.cc}!exif\_methods@{exif\_methods}}
\index{exif\_methods@{exif\_methods}!lua.cc@{lua.cc}}
...
Call by e.\+g. ~\newline
\doxyref{$<$exif-\/structure$>$\+:get\+\_\+datum() }{p.}{lua_8cc_ac9ce283551bf63c8147cb780bff5d209} ~\newline
where $<$exif-\/structure$>$ is the output of \doxyref{Image\+:get\+\_\+exif() }{p.}{lua_8cc_a085dc763b1a2fc6e8eeb4e0bb315268e} 

exif\+\_\+structure = Image\+:get\+\_\+exif(); ~\newline
Date\+Time\+Digitized = exif\+\_\+structure\+:get\+\_\+datum("{}\+Exif.\+Photo.\+Date\+Time\+Digitized"{}); \label{lua_8cc_ac8629eaf0c7d181e68644c972af0c5c4} 
\index{lua.cc@{lua.cc}!image\_methods@{image\_methods}}
\index{image\_methods@{image\_methods}!lua.cc@{lua.cc}}
